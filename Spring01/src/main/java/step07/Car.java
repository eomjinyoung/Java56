...
public class Car {
  ...
  @Autowired(required=false) // 선택 입력으로 바뀐다. Engine 타입의 인스턴스를 찾지 못하더라도 오류 발생시키지 않는다.
